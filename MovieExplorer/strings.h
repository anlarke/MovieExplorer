...
inline void LoadStrings()
{
	...
	GetLangMgr()->SetString(nLanguage, 50, _T("Categorieën"), false);
	...
	GetLangMgr()->SetString(nLanguage, 64, _T("Weet u zeker dat u dit bestand permanent van de computer wilt verwijderen?"), false);
	GetLangMgr()->SetString(nLanguage, 65, _T("Weet u zeker dat u deze map permanent van de computer wilt verwijderen?"), false);
	...
	GetLangMgr()->SetString(nLanguage, 71, _T("Afspelen"), false);
	GetLangMgr()->SetString(nLanguage, 72, _T("Map openen"), false);
	GetLangMgr()->SetString(nLanguage, 73, _T("Gezien"), false);
	GetLangMgr()->SetString(nLanguage, 74, _T("Bewerken"), false);
	GetLangMgr()->SetString(nLanguage, 75, _T("Verbergen"), false);
	GetLangMgr()->SetString(nLanguage, 76, _T("Verwijderen"), false);
